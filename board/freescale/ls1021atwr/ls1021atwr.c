...
int board_early_init_f(void)
{
	...
	serdes_sata_strength = in_be32(&serdes->lane[1].tecr0) & 0xFFFFFFC0;
	out_be32(&serdes->lane[1].tecr0, serdes_sata_strength | 0x0D);	//SATA Gen1(1.5G) strength 

	serdes_sata_strength = in_be32(&serdes->lane[1].sscr0) & 0xFFFFFFC0;
	out_be32(&serdes->lane[1].sscr0, serdes_sata_strength | 0x04);	//SATA Gen2(3G) strength
	
	serdes_sata_strength = in_be32(&serdes->lane[1].sscr1) & 0xFFFFFFC0;
	out_be32(&serdes->lane[1].sscr1, serdes_sata_strength | 0x01);	//SATA Gen3(6G) strength
