...
#define DDR_TIMING_CFG_0		0x40550004
...
#define DDR_DDR_WRLVL_CNTL_2		0x04050408
#define DDR_DDR_WRLVL_CNTL_3		0x08090900
#define DDR_DDR_CDR2			0x00000000	
#define DDR_SDRAM_MODE			0x00461c70	
#define DDR_SDRAM_CFG			0x472c0008
#define DDR_DDR_WRLVL_CNTL		0x8655f604
#define DDR_DDR_WRLVL_CNTL_2		0x03040300
#define DDR_DDR_WRLVL_CNTL_3		0x00000000
#define DDR_DDR_CDR2			0x00000001
#define DDR_SDRAM_MODE			0x00441c70	
#define DDR_DDR_CDR1			0x80040000
#define DDR_SDRAM_CLK_CNTL		0x01c00000	
...
#define DDR_DDR_WRLVL_CNTL              0x8655f604
#define DDR_DDR_WRLVL_CNTL_2            0x04050407
#define DDR_DDR_WRLVL_CNTL_3            0x05050505
#define DDR_DDR_CDR2                    0x00000001
#define DDR_SDRAM_MODE                  0x00441c60
#define DDR_DDR_CDR1                    0x80040000
...
#define CONFIG_SYS_FSL_PBL_RCW	board/freescale/ls1021atwr/ls102xa_rcw_spi.cfg
...
#define MP_MEMTEST_SIZE	    (1u * 1024 * 1024 * 1024)
...
#define CONFIG_SYS_CPLD_CSOR (CSOR_NOR_ADM_SHIFT(16) | \
	...
	CSOR_NOR_TRHZ_80 | \
	CSOR_NOR_BCTLD)
#define CONFIG_SYS_CPLD_FTIM0		(FTIM0_GPCM_TACSE(0xe) | \
					FTIM0_GPCM_TEADC(0xe) | \
					FTIM0_GPCM_TEAHC(0xe))
#define CONFIG_SYS_CPLD_FTIM1		(FTIM1_GPCM_TACO(0xe) | \
					FTIM1_GPCM_TRAD(0x1f))
#define CONFIG_SYS_CPLD_FTIM2		(FTIM2_GPCM_TCS(0xe) | \
					FTIM2_GPCM_TCH(0xe) | \
					FTIM2_GPCM_TWP(0xf0))
...
#define CONFIG_MOXA_WDT_DIAG
#define CONFIG_MOXA_WDT_DS1374
...
#define CONFIG_LOADADDR			0x86000000 
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"ethaddr=00:90:e8:00:00:40\0" \
	"eth1addr=00:90:e8:00:00:50\0" \
	"eth2addr=00:90:e8:00:00:60\0" \
	"ipaddr=192.171.1.34\0" \
	"modelname=UC-8410A-LX\0" \
	"customer_id=IMOXA1234567\0" \
	"fastboot=0\0" \
	"serverip=192.171.1.5\0"
#endif
...
#define CONFIG_SYS_MEMTEST_END		0x9e7fe000	
